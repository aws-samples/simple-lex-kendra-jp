...
export interface FaqCustomResourceProps extends CreateFaqCommandInput {}

export class FaqCustomResource extends Construct {
  public readonly resource: cdk.CustomResource;

  constructor(scope: Construct, id: string, props: FaqCustomResourceProps) {
    super(scope, id);
